...
| **Production Excel** | `C:\Users\cm-andrade\OneDrive - CRITICAL SOFTWARE, S.A\WRSHALLOWFORD - BSP_G2 (Moreira)\BSP-G2_Daily_Tracker.xlsx` | Main sheet: `PRJ_CFG1_reworks_julho`. Status list sheet: `Admin`. |
